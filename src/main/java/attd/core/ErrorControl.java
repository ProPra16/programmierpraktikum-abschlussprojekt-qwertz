...
public class ErrorControl extends TableView<CompileError> {
	public ErrorControl() {
		...
		TableColumn<CompileError, String> tc2 = new TableColumn<>("CodeLine");
		...
		TableColumn<CompileError, String> tc3 = new TableColumn<>("ColumnNumber");
		...
		TableColumn<CompileError, String> tc4 = new TableColumn<>("LineNumber");
